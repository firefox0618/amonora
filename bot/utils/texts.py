...
def device_slot_methods_text(
    *,
    ...
    lines = [
        ...
        "Этот доп. слот покупается отдельно и действует ровно 1 месяц с момента оплаты.",
        "Срок доп. слота не зависит от даты окончания основной подписки.",
    ]
    ...
    *,
    ...
    lines.extend(
        [
            ...
            "Этот доп. слот действует ровно 1 месяц с момента оплаты.",
            "Срок доп. слота не привязан к окончанию основной подписки.",
        ]
    )
    return "\n".join(lines)
    ...
    if can_buy_more:
        ...
        lines.extend(
            [
                ...
                "Удалите лишние устройства или купите новый доп. слот на 1 месяц.",
            ]
        )
    else:
        lines.extend(
