...
class PaymentRecord(Base):
    ...
    list_price_amount: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
    balance_reserved_amount: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
    balance_applied_amount: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
